...
```{r}
hist(steps.date$steps, col="green", main="Number of steps taken per day", xlab="Number of steps", ylab="Frecuency")
```
...
datos$steps[steps.NA] <- datos$steps.y[steps.NA]
datos <- datos[, c(1:3)]
...
vector_datos <- c(table_interval_steps$steps)
#print("Generating the plot1.png file .....")
#png(file="./plot1.png", width = 480, height = 480, units = "px") # open file png

hist(vector_datos, col="red", main="Number of steps taken per day", xlab="Number of steps", ylab="Frecuency")
